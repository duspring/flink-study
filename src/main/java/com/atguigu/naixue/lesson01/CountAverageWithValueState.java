...
public class CountAverageWithValueState
    ...
    // 用以保存每个 key 出现的次数，以及这个key对应的 value的值
    // managed keyed state
...
*          Long:
    ...
    public void flatMap(Tuple2<Long, Long> element,
        ...
        if (currentState.f0 == 3) {
            double avg = (double)currentState.f1 / currentState.f0; // currentState.f0 直接写成3也可以
            // 输出 key 及其对应的平均值 element.f0为当前的key
